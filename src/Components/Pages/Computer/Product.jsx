...
<form className="flex items-center gap-2 w-full">
  ...
  {/* Combo Box for Terminal Filter */}
  {/* <div>
    <select
      value={selectedTerminal}
      onChange={(e) => setSelectedTerminal(e.target.value)}
      className="p-2 text-[12px] border border-gray-300 rounded-lg bg-gray-50 focus:ring-primary-500 focus:border-primary-500"
    >
      <option value="">All Terminals</option>
      <option value="TS3">TS3</option>
      <option value="LM17">LM17</option>
    </select>
  </div> */}
</form>
