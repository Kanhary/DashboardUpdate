...
const RequestHistory = () => {
      ...
      const filteredWifeInfo = notifications.filter(
        (wife) =>
          (wife.description?.toLowerCase() || "").includes(searchTerm.toLowerCase()) ||
          wife.id?.includes(searchTerm) ||
          ""
      );
  ...
  return (
    <section className="font-khmer mt-10">
      <h1 className="text-md font-medium text-blue-800">Request History</h1>
            ...
            <table className="w-full text-sm text-left text-gray-500">
              ...
              <tbody>
                {currentWife.map((wife) => (
                  <tr
                    key={wife.id}
                    className="transition-colors duration-200 border border-b-gray-200 hover:bg-indigo-50 text-[13px]"
                  >
                      <td className="px-4 py-2 border-r text-[12px]">
                      <button
                    ...
                    <td className="px-4 py-2 border-r">{wife.userId}</td>
                    <td className="px-4 py-2 border-r">{wife.departmentId}</td>
                    <td className="px-4 py-2 border-r  whitespace-nowrap text-ellipsis max-w-[150px] text-[12px] overflow-hidden">{wife.description}</td>
                    <td className="px-4 py-2 border-r">{wife.status}</td>
                    {/* <td className='px-4 py-4 border-r'>{wife.genderCode}</td> */}
                    <td className="px-4 py-2 border-r  whitespace-nowrap text-ellipsis max-w-[150px] text-[12px] overflow-hidden">{wife.createdAt}</td>
