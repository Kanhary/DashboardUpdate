...
const Department = () => {
  ...
  return (
    <section className="mt-10 font-khmer">
      <h1 className="text-md font-medium text-blue-800">តារាងបញ្ជីនាយកដ្ឋាន</h1>
            ...
            <table className="w-full text-[12px] text-left text-gray-500">
              <thead className="text-xs text-gray-700 uppercase bg-gray-100 border">
                <tr>
                  <th
                    scope="col"
                    className="sticky left-0 px-4 py-2 bg-gray-100 border-r"
                  >
                    Action
                  </th>
                  <th
              ...
              <tbody>
                {currentDepartment.map((dep, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2 border-r">{dep.departCode}</td>
                    <td className="px-4 py-2 border-r">{dep.departEngName}</td>
                    <td className="px-4 py-2 border-r">{dep.departKhName}</td>
                    <td className="px-4 py-2 border-r">{dep.branchCode}</td>
                  </tr>
                ))}
              </tbody>
            </table>
              ...
              <div className="flex flex-col space-y-6 md:flex-row md:space-x-6 md:space-y-0">
                ...
                <div className="w-full md:w-1/2">
                  ...
                  <Select
                    ...
                    value={optionsBranch.find(
                      (option) => option.value === formData.branchCode
                    )}
                    isClearable
