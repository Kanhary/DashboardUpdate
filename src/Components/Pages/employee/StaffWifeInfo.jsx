...
import { GetUserLogin, GetAllStaff, AddWife, UpdateWife, DeleteWife, GetAllwife} from '../../../api/user';
...
const StaffWifeInfo = () => {
  ...
  const filteredWifeInfo = WifeInfo.filter(wife =>
  ...
  const currentWife = filteredWifeInfo.slice(indexOfFirstRecord, indexOfLastRecord);
  ...
  const closeEditModal = () => {
    ...
    setFormData({ EngName: '', KhName: '', WifeCode: '', StaffCode: '', BOD: '', WifeJob: '', Adddres: ''});
          ...
          <div className='w-full overflow-x-auto' data-aos='fade-right'>
            <table className='w-full text-sm text-left text-gray-500'>
              ...
              <tr>
                ...
                <th scope="col" className="px-4 py-3 border-t border-r" style={{ minWidth: '150px' }}>Wife Code</th>
                ...
                <th scope="col" className="px-4 py-3 border-t border-r" style={{ minWidth: '100px' }}>Spouse Job</th>
              ...
              <tbody>
                {currentWife.map(wife=> (
                  <tr key={wife.id} className='transition-colors duration-200 border border-b-gray-200 hover:bg-indigo-50'>
