...
import { GetUserLogin, GetAllComputerCourse, AddComputerCourse, UpdateComputerCourse, DeleteComputerCourse, GetAllStaff} from '../../../api/user';
...
const ComputerCourse = () => {
  ...
  const [editingComputerCourse, setEditingComputerCourse] = useState(null);
  ...
  const currentComputerCourse = filteredComputerCourse.slice(indexOfFirstRecord, indexOfLastRecord);
                    ...
                    <td className="sticky left-0 h-full px-4 py-3 bg-white border-r" >
                      ...
                      {/* <input type="checkbox" className="mr-1 action-checkbox"/> */}
                        <button
                          ...
                          onClick={() => openEditModal(computerCourse)}
                        >
                          <FaPen />
                        </button>
                        <button
