...
const EmployeeChild = () => {
  ...
  const filteredChildInfo = ChildInfo.filter(
    (child) =>
      (child.EngChildName?.toLowerCase() || "").includes(
  ...
  const currentChildJob = filteredChildInfo.slice(
    indexOfFirstRecord,
    indexOfLastRecord
  );
              ...
              <tbody>
                {currentChildJob.map((child) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2 border-r">{child.childCode}</td>
                    <td className="px-4 py-2 border-r">{child.engChildName}</td>
                    <td className="px-4 py-2 border-r">{child.khChildName}</td>
                    <td className="px-4 py-2 border-r">{child.staffCode}</td>
                    <td className="px-4 py-2 border-r">{child.genderCode}</td>
                    <td className="px-4 py-2 border-r">{child.bod}</td>
                    <td className="px-4 py-2 border-r">{child.childJob}</td>
                    <td className="px-4 py-2 border-r">{child.address}</td>
                    <td className="px-4 py-2 border-r">{child.LastBy}</td>
                    <td className="px-4 py-2 border-r">{child.LastDate}</td>
                  </tr>
                ))}
              </tbody>
            </table>
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                  ...
                  <Select
                    ...
                    value={optionGenderCode.find(
                      (option) => option.value === formData.genderCode
                    )}
                    placeholder="Select or type to search"
                    className="basic-single"
                    classNamePrefix="select"
