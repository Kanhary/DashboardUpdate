  ...
  return (
        ...
        data-aos='zoom-in-up duration-1000'>
              ...
              <div className="flex space-x-4 border-b">
                <button
                  className={`p-2 ${activeTab === 'បញ្ចូលព័ត៌មានបុគ្គលិក' ? 'border-b-2 border-blue-500' : ''}`}
                  onClick={() => setActiveTab('បញ្ចូលព័ត៌មានបុគ្គលិក')}
                >
                  បញ្ចូលព័ត៌មានបុគ្គលិក
                </button>
                <button
                  className={`p-2 ${activeTab === 'វគ្គសិក្សា' ? 'border-b-2 border-blue-500' : ''}`}
            ...
            <form onSubmit={handleFormSubmit} className="p-6 space-y-6" data-aos='zoom-in'>
              ...
              <div>
                ...
                <Select
                    ...
                    value={optionsStaffCode.find(option => option.value === DataCourse.staffcode)}
                ...
                <Select
                    ...
                    value={optionsStaffName.find(option => option.value === DataCourse.staffname)}
                    placeholder="Select or type to search staff name"
                    className="basic-single"
                    classNamePrefix="select"
                    styles={customStyles}
                />
                {errors.staffname && <p className="mt-1 text-xs text-red-500">{errors.staffname}</p>}
                </div>
